...
#
# extension: 16 cells x 3 smaller radii = 48 runs. 10m->10m peaked at 0.06,
# the bottom of the original range, so the optimum was not bracketed.. No board needed; templates and evaluation
