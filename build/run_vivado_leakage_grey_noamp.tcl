...
set BUILD_NAME leakage_greynoamp_d${DWELL}
...
foreach f [list \
    ...
    ../cw305/cdc_pulse.v ../cw305/mnist_leakage_core_grey_noamp.sv \
    ../cw305/cw305_reg_leakage_grey.sv ../cw305/cw305_leakage_grey_top.sv \
...
add_files -fileset sources_1 ../cw305/mnist_leakage_core_grey_noamp.sv
add_files -fileset sources_1 ../cw305/cw305_reg_leakage_grey.sv
add_files -fileset sources_1 ../cw305/cw305_leakage_grey_top.sv
set_property file_type SystemVerilog [get_files *.sv]

set_property top cw305_leakage_grey_top [current_fileset]
...
set bitfile ./vivado_${BUILD_NAME}/cw305_${BUILD_NAME}.runs/impl_1/cw305_leakage_grey_top.bit
