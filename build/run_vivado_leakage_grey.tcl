...
set BUILD_NAME leakage_grey_d${DWELL}_l${LEAK_LANES}
...
foreach f [list \
    ...
    ../cw305/cdc_pulse.v ../cw305/mnist_leakage_core_grey.sv \
...
add_files -fileset sources_1 ../cw305/mnist_leakage_core_grey.sv
